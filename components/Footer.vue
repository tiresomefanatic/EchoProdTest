    ...
    <div style="margin-top: 64px;">
      ...
      <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 64px;">
        ...
        <div>
          ...
          <p style="color: #1E1E1E; font-family: 'PP Neue Montreal'; font-size: 14px; font-style: normal; font-weight: 400; line-height: 140%; margin: 0 0 16px;">All ECHO docs are open source. See something that's wrong or unclear? Submit a pull request</p>
